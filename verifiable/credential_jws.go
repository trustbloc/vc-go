...
func (jcc *JWTCredClaims) MarshalJWS(signatureAlg JWSAlgorithm, signer Signer,
...
func (jcc *JWTCredClaims) MarshalJWSString(signatureAlg JWSAlgorithm, signer Signer, keyID string) (string, error) {
