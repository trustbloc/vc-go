...
type bbsProofDelivery interface {
...
type Creator struct {
	ProofDelivery              bbsProofDelivery
...
func SelectiveDisclosure(doc map[string]interface{}, revealDoc map[string]interface{},
	nonce []byte, bbsProofCreator *Creator, opts ...processor.Opts) (map[string]interface{}, error) {
...
func generateSignatureProof(blsSignature map[string]interface{}, creator *Creator, nonce []byte,
	...
	signatureProofBytes, err := creator.ProofDelivery.DeriveProof(verData.blsMessages, signatureBytes,
